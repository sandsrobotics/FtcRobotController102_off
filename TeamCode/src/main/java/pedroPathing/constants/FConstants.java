...
public class FConstants {
    static {
        ...
        FollowerConstants.leftFrontMotorName = "motor0";
        FollowerConstants.leftRearMotorName = "motor2";
        FollowerConstants.rightFrontMotorName = "motor1";
        FollowerConstants.rightRearMotorName = "motor3";
