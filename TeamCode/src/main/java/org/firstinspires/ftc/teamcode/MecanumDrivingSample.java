...
public class MecanumDrivingSample extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        MecanumDrive drive = new MecanumDrive(
                new Motor(hardwareMap, "motor0", Motor.GoBILDA.RPM_312),
                new Motor(hardwareMap, "motor1", Motor.GoBILDA.RPM_312),
                new Motor(hardwareMap, "motor2", Motor.GoBILDA.RPM_312),
                new Motor(hardwareMap, "motor3", Motor.GoBILDA.RPM_312)
        );
